	...
	**/
	public static boolean saveGame(Client p) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.newLine();
			characterfile.write("Bankpins are fun", 0, 16);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.newLine();
			characterfile.write("dungeonPoints = ", 0, 16);
			characterfile.write(Integer.toString(p.dungeonPoints), 0, Integer.toString(p.dungeonPoints).length());
			characterfile.newLine();
