		...
		c.sendMessage("You need atleast 350,000 coins to use this feature.");
			...
			case 62158:
				...
				c.getPA().sendFrame126("@or1@Combat Level: @gre@"+c.combatLevel+"", 26108);
					...
					if(c.isDonator == true && c.playerRights == 0) {
...
c.sendMessage("You do not have a npc currently spawned");
			...
			case 9190:
				if (c.teleAction == 1) {
					//rock crabs
					c.getPA().spellTeleport(2666, 3661, 0);
...
break;
			...
			case 117131:
			case 4146:
			c.getDH().sendOption5("Godwars", "King Black Dragon/Frost Dragons", "Dagannoth Kings", "Tormented Demons", "Corporeal Beast");
			c.teleAction = 3;
			break;
