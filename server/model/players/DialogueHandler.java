...
break;		
	...
	case 51:
			...
			break;
		case 32:
			sendNpcChat4("You cannot Escape yet!","You've killed "+c.monkeyk0ed+" out of 20 monkeys!","Come back when you have killed 20","come back with 20 kills", c.talkingNpc, "Mosol Rei");
			c.dialogueAction = 30;
			c.nextChat = 0;
			break;
		case 0:
		...
		break;
               case 70:
			sendNpcChat4("I have found two secret tunnels!", "I saw a giant mole and a Kalphite Queen!", "Help me defeating them?", 
