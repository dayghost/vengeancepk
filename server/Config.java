...
public class Config {
	...
	public static final String SERVER_NAME = "Vengeance PK";
	public static final String WELCOME_MESSAGE = "Welcome to Vengeance PK";
	public static final String FORUMS = "http://www.vengeancpk.cu.cc/";
	...
	public static final int[] ITEM_SELLABLE 		=	{3842,12513,12515,12517,12519,12521,12523,12476,12470,12472,12474,3844,3840,8844,8845,8846,8847,8848,8849,8850,10551,6570,7462,7461,7460,7459,7458,7457,7456,7455,7454,7453,8839,8840,8842,11663,11664,11665,10499,
	...
	public static final int START_LOCATION_X = 3091; // start here
	public static final int START_LOCATION_Y = 3104;
	public static final int RESPAWN_X = 3351; // when dead respawn here
	public static final int RESPAWN_Y = 3343;
	public static final int DUNG_RESPAWN_X = 3351; // when dead respawn here
	public static final int DUNG_RESPAWN_Y = 3343;
	...
	//public static final int SKILL_EXP = 100; // Runescape Skills Xp * SKILL_EXP
	
	public static final int MELEE_EXP_RATE = 1400; // damage * exp rate
	public static final int RANGE_EXP_RATE = 1600;
	public static final int MAGIC_EXP_RATE = 1600;
